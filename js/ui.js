...
function toggleLoading(isLoading) {
  ...
  if (isLoading) {
    btn.disabled = true;
    btn.innerHTML = "";
    let elem1 = document.createElement("i");
    let elem2 = document.createElement("span");
    let text = document.createTextNode("Loading...");
    elem1.setAttribute("class", "fas fa-hourglass-half");
    elem1.setAttribute("title", "Loading");
    elem2.appendChild(elem1);
    elem2.appendChild(text);
    btn.appendChild(elem2);
  } else {
    btn.disabled = false;
    btn.innerHTML = "";
    let elem1 = document.createElement("i");
    ...
    elem1.setAttribute("class", "fas fa-search");
    elem1.setAttribute("title", "search");
    elem2.appendChild(elem1);
    elem2.appendChild(text);
    btn.appendChild(elem2);
  }
